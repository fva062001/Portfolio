...
export function Skills() {
  return (
    <div className="h-screen w-screen flex flex-col md:flex-row justify-items-center align-middle">
      <div className="w-full md:w-1/2 lg:h-full flex md:items-center md:justify-center px-12 mb-8 md:mb-0">
